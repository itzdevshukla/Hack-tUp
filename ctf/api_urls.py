...
urlpatterns = [
    ...
    path('admin/event/<hashid:event_id>/banned-users/', admin_api.admin_event_banned_users_api, name='api_admin_event_banned_users'),
    path('admin/event/<hashid:event_id>/banned-users/unban-all/', admin_api.admin_unban_all_users_api, name='api_admin_unban_all_users'),
    ...
    path('admin/event/<hashid:event_id>/user/<hashid:user_id>/export/', admin_api.admin_export_user_data_api, name='api_admin_export_user_data'),
